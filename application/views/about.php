  ...
  <div class="container">
    <div class="row display_boxflex">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <h2>Tentang Kami</h2>
          <p>AsiqueFest merupakan Festival Musik tahunan yang diselenggarakan oleh Asqprjkt. Berbeda dari tahun-tahun sebelumnya, kali ini AsiqueFest 2030 akan diselenggarakan 2 hari yaitu 24 Agustus 2030 s/d 25 Agustus 2030. Bertempat di Parking Area Summarecon Mall Bekasi, SoundFest 2030 akan menghadirkan 20 Line Up Artist. Line Up Artist yang terlibat dalam SoundFest 2030 akan diumumkan bertahap melalui akun Instagram official AsiqueFest @asiquefest. Tunggu apalagi segera dapatkan tiketnya dan nikmati sajian penampilan Artist Favorit mu dalam panggung AsiqueFest 2030</p>
          
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <figure><img src="<?php echo base_url('assets/images/about2.png') ?>" alt="#" /></figure>
        </div>
      </div>
    </div>
