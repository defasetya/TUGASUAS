                ...
                <div class="limit-box">
                  <nav class="main-menu ">
                    ...
                    <li> <a href="<?php echo base_url('welcome/concerts') ?>">Concerts </a> </li>
                      <li class="active"> <a href="<?php echo base_url() . 'welcome/gallery' ?>">Gallery</a> </li>
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott">
            <div class="Gallery_img">
              <figure><img src="<?php echo base_url('assets/images/Gallery5.jpg') ?>" alt="#"/></figure>
            </div>
            <div class="hover_box">
             
              <ul class="icon_hu">
                 <h3>DEWA 19</h3>
                <li><a href="#"><img src="<?php echo base_url('assets/icon/h.png') ?>" alt="#"/></a></li>
                 <li><a href="#"><img src="<?php echo base_url('assets/icon/h.png') ?>" alt="#"/></a></li>
              </ul>
            </div>
          </div>
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott">
            <div class="Gallery_img">
              <figure><img src="<?php echo base_url('assets/images/Gallery6.jpg') ?>" alt="#"/></figure>
            </div>
            <div class="hover_box">
             
              <ul class="icon_hu">
                 <h3>ISYANA SARASVATI X DEADSQUAD</h3>
                <li><a href="#"><img src="<?php echo base_url('assets/icon/h.png') ?>" alt="#"/></a></li>
                 <li><a href="#"><img src="<?php echo base_url('assets/icon/h.png') ?>" alt="#"/></a></li>
              </ul>
            </div>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margi_bott1">
            <div class="Gallery_img">
              <figure><img src="<?php echo base_url('assets/images/Gallery7.jpg') ?>" alt="#"/></figure>
            </div>
            <div class="hover_box">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            <div class="Gallery_img">
              <figure><img src="<?php echo base_url('assets/images/Gallery8.jpg') ?>" alt="#"/></figure>
            </div>
            <div class="hover_box">
